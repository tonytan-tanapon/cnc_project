...
function initTable(){
  ...
  table = new Tabulator(tableMount, {
    ...
    columns: [
      { title: "No.", field: "_rowno", width: 60, hozAlign: "center", headerHozAlign: "right", headerSort: false,
        formatter: (cell) => {
      ...
      { title: "Part No", field: "part_no", minWidth: 110, headerSort: true,
        formatter: (cell) => {
      ...
      { title: "Part Name", field: "part_name",minWidth: 110, headerSort: true,},
