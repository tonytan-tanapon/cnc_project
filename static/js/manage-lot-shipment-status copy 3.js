  ...
  return [
    {
      ...
      formatter: (cell) => {
        ...
        const href = `/static/lot-detail.html?lot_id=${encodeURIComponent(
          lotId
        )}`;
      ...
      cellClick: (e, cell) => {
        ...
        const lotId = d.lot_id;
        if (!lotId) return;
        location.href = `/static/lot-detail.html?lot_id=${encodeURIComponent(
          lotId
        )}`;
      },
    },
...

    {
      ...
      cellEdited: async (cell) => {
        ...
        // try {
        //   const res = await jfetch("lots/test/", { method: "GET" });
        //   console.log("Test PATCH response:", res);
        // } catch (err) {
        //   console.error("Test PATCH failed:", err);
        // }
