# python database_import/import_combine_lot_to_db.py
...
if __name__ == "__main__":
    ...
    import_excel(r"Z:\Topnotch Group\Public\Testing APP\all lot\lot_report_format.xlsx")
