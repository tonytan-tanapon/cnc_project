...
from . import (
    auth, customers, pos, employees, materials, batches, lots, reports, reports_traveler,#lot_uses, 
    ...
    reports_traveler,material_traceability,raw_batches,part_inventory,payroll_service,service,tickets,lot_stamp,test,
)



api_v1 = APIRouter()
api_v1.include_router(script_runner.router)
...
api_v1.include_router(step_logs.router)
api_v1.include_router(machines.router)

api_v1.include_router(traveler_templates.router)

api_v1.include_router(icars.router)
api_v1.include_router(ecars.router)
api_v1.include_router(reports_traveler.router)
...
api_v1.include_router(service.router)
api_v1.include_router(tickets.router)
api_v1.include_router(lot_stamp.router)
api_v1.include_router(test.router)
