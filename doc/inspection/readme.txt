...
powershell -ExecutionPolicy Bypass -File "C:\Users\TPSERVER\dev\cnc_project\doc\inspection\generate.ps1"
powershell -ExecutionPolicy Bypass -File "C:\Users\TPSERVER\dev\cnc_project\doc\inspection\runall.ps1"
...
Step 1: 
    ...
    $OutputRoot  = "C:\docs\inspection\output"     # mirror structure
    $OutputRoot2 = "C:\docs\inspection\result"    # flat
...
Step 2: 
    ...
    the file will be created at $OutputRoot2 = "C:\docs\inspection\result"    # flat
