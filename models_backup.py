from sqlalchemy import (
    ...
    Numeric, Boolean, CheckConstraint, ForeignKeyConstraint, select
)
from sqlalchemy.sql import func
from sqlalchemy.orm import validates, object_session, relationship, column_property, aliased
...
class CustomerInvoiceLine(Base):
    ...
    shipment_item_id = Column(Integer, ForeignKey("customer_shipment_items.id"), nullable=True)
    qty = Column(Numeric(18,3), nullable=False)
